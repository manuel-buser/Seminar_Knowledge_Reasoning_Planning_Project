(define (problem spider-2-2-8-6-2-2900)
(:domain spider-axioms)
; Using 2 decks of cards with 2 suits per deck and 8 values per suit
;
; Deals
; deal 0: d0-s1-v5 d0-s1-v4 d0-s1-v1 d1-s1-v2 d0-s0-v4 d0-s0-v5
; deal 1: d0-s0-v3 d1-s0-v4 d0-s1-v7 d1-s1-v1 d1-s1-v4 d1-s1-v0
;
; Initial configuration of piles
; pile 0: d1-s0-v1 d0-s0-v7 d1-s0-v3 d1-s1-v6
; pile 1: d1-s1-v7 d0-s0-v2 d1-s0-v7 d1-s1-v5
; pile 2: d0-s0-v6 d0-s1-v6 d0-s0-v0
; pile 3: d0-s1-v2 d0-s0-v1 d1-s0-v5
; pile 4: d0-s1-v0 d1-s0-v2 d1-s1-v3
; pile 5: d0-s1-v3 d1-s0-v0 d1-s0-v6
(:objects
    card-d0-s0-v0 - card
    card-d0-s0-v1 - card
    card-d0-s0-v2 - card
...
(:init
    (on card-d0-s0-v7 card-d1-s0-v1)
    (on card-d1-s0-v3 card-d0-s0-v7)
    (on card-d1-s1-v6 card-d1-s0-v3)
    (on card-d1-s0-v1 pile-0)
    (clear card-d1-s1-v6)
    (in-play card-d1-s0-v1)
    (in-play card-d0-s0-v7)
    (in-play card-d1-s0-v3)
    (in-play card-d1-s1-v6)
    (on card-d0-s0-v2 card-d1-s1-v7)
    (on card-d1-s0-v7 card-d0-s0-v2)
    (on card-d1-s1-v5 card-d1-s0-v7)
    (on card-d1-s1-v7 pile-1)
    (clear card-d1-s1-v5)
    ...
    (on card-d0-s0-v0 card-d0-s1-v6)
    (on card-d0-s0-v6 pile-2)
    (clear card-d0-s0-v0)
    (in-play card-d0-s0-v6)
    (in-play card-d0-s1-v6)
    (in-play card-d0-s0-v0)
    (on card-d0-s0-v1 card-d0-s1-v2)
    (on card-d1-s0-v5 card-d0-s0-v1)
    (on card-d0-s1-v2 pile-3)
    (clear card-d1-s0-v5)
    (in-play card-d0-s1-v2)
    (in-play card-d0-s0-v1)
    (in-play card-d1-s0-v5)
    (on card-d1-s0-v2 card-d0-s1-v0)
    (on card-d1-s1-v3 card-d1-s0-v2)
    (on card-d0-s1-v0 pile-4)
    (clear card-d1-s1-v3)
    (in-play card-d0-s1-v0)
    (in-play card-d1-s0-v2)
    (in-play card-d1-s1-v3)
    (on card-d1-s0-v0 card-d0-s1-v3)
    (on card-d1-s0-v6 card-d1-s0-v0)
    (on card-d0-s1-v3 pile-5)
    (clear card-d1-s0-v6)
    (in-play card-d0-s1-v3)
    (in-play card-d1-s0-v0)
    (in-play card-d1-s0-v6)
    (on card-d0-s1-v5 deal-0)
    (on card-d0-s1-v4 card-d0-s1-v5)
    (on card-d0-s1-v1 card-d0-s1-v4)
    (on card-d1-s1-v2 card-d0-s1-v1)
    (on card-d0-s0-v4 card-d1-s1-v2)
    (on card-d0-s0-v5 card-d0-s0-v4)
    (clear card-d0-s0-v5)
    (on card-d0-s0-v3 deal-1)
    (on card-d1-s0-v4 card-d0-s0-v3)
    (on card-d0-s1-v7 card-d1-s0-v4)
    (on card-d1-s1-v1 card-d0-s1-v7)
    (on card-d1-s1-v4 card-d1-s1-v1)
    (on card-d1-s1-v0 card-d1-s1-v4)
    (clear card-d1-s1-v0)
    (current-deal deal-0)
    ...
    (TO-DEAL card-d0-s1-v5 pile-5 deal-0 deal-0)
    (TO-DEAL card-d0-s0-v5 pile-0 deal-0 card-d0-s0-v4)
    (TO-DEAL card-d0-s0-v4 pile-1 deal-0 card-d1-s1-v2)
    (TO-DEAL card-d1-s1-v2 pile-2 deal-0 card-d0-s1-v1)
    (TO-DEAL card-d0-s1-v1 pile-3 deal-0 card-d0-s1-v4)
    (TO-DEAL card-d0-s1-v4 pile-4 deal-0 card-d0-s1-v5)
    (TO-DEAL card-d0-s0-v3 pile-5 deal-1 deal-1)
    (TO-DEAL card-d1-s1-v0 pile-0 deal-1 card-d1-s1-v4)
    (TO-DEAL card-d1-s1-v4 pile-1 deal-1 card-d1-s1-v1)
    (TO-DEAL card-d1-s1-v1 pile-2 deal-1 card-d0-s1-v7)
    (TO-DEAL card-d0-s1-v7 pile-3 deal-1 card-d1-s0-v4)
    (TO-DEAL card-d1-s0-v4 pile-4 deal-1 card-d0-s0-v3)
    (= (total-cost) 0)
)
(:goal
(and
