(define (problem spider-1-4-7-5-2-3401)
(:domain spider-axioms)
; Using 1 decks of cards with 4 suits per deck and 7 values per suit
;
; Deals
; deal 0: d0-s2-v3 d0-s2-v1 d0-s0-v4 d0-s2-v0 d0-s3-v5
; deal 1: d0-s3-v6 d0-s1-v1 d0-s0-v5 d0-s2-v5 d0-s1-v4
;
; Initial configuration of piles
; pile 0: d0-s0-v6 d0-s1-v6 d0-s1-v5 d0-s1-v2
; pile 1: d0-s1-v0 d0-s3-v2 d0-s2-v2 d0-s1-v3
; pile 2: d0-s3-v1 d0-s3-v0 d0-s0-v2 d0-s3-v3
; pile 3: d0-s0-v3 d0-s0-v0 d0-s0-v1
; pile 4: d0-s2-v6 d0-s2-v4 d0-s3-v4
(:objects
    card-d0-s0-v0 - card
    card-d0-s0-v1 - card
    card-d0-s0-v2 - card
...
(:init
    ...
    (on card-d0-s1-v5 card-d0-s1-v6)
    (on card-d0-s1-v2 card-d0-s1-v5)
    ...
    (on card-d0-s3-v2 card-d0-s1-v0)
    (on card-d0-s2-v2 card-d0-s3-v2)
    (on card-d0-s1-v3 card-d0-s2-v2)
    (on card-d0-s1-v0 pile-1)
    (clear card-d0-s1-v3)
    ...
    (on card-d0-s3-v3 card-d0-s0-v2)
    (on card-d0-s3-v1 pile-2)
    (clear card-d0-s3-v3)
    ...
    (on card-d0-s0-v1 card-d0-s0-v0)
    (on card-d0-s0-v3 pile-3)
    (clear card-d0-s0-v1)
    (in-play card-d0-s0-v3)
    (in-play card-d0-s0-v0)
    (in-play card-d0-s0-v1)
    (on card-d0-s2-v4 card-d0-s2-v6)
    (on card-d0-s3-v4 card-d0-s2-v4)
    (on card-d0-s2-v6 pile-4)
    (clear card-d0-s3-v4)
    (in-play card-d0-s2-v6)
    (in-play card-d0-s2-v4)
    (in-play card-d0-s3-v4)
    (on card-d0-s2-v3 deal-0)
    (on card-d0-s2-v1 card-d0-s2-v3)
    (on card-d0-s0-v4 card-d0-s2-v1)
    (on card-d0-s2-v0 card-d0-s0-v4)
    (on card-d0-s3-v5 card-d0-s2-v0)
    (clear card-d0-s3-v5)
    (on card-d0-s3-v6 deal-1)
    (on card-d0-s1-v1 card-d0-s3-v6)
    (on card-d0-s0-v5 card-d0-s1-v1)
    (on card-d0-s2-v5 card-d0-s0-v5)
    (on card-d0-s1-v4 card-d0-s2-v5)
    (clear card-d0-s1-v4)
    (current-deal deal-0)
    ...
    (IS-KING card-d0-s1-v6)
    (IS-KING card-d0-s2-v6)
    (IS-KING card-d0-s3-v6)
    (NEXT-DEAL deal-0 deal-1)
    (NEXT-DEAL deal-1 deal-2)
    (TO-DEAL card-d0-s2-v3 pile-4 deal-0 deal-0)
    (TO-DEAL card-d0-s3-v5 pile-0 deal-0 card-d0-s2-v0)
    (TO-DEAL card-d0-s2-v0 pile-1 deal-0 card-d0-s0-v4)
    (TO-DEAL card-d0-s0-v4 pile-2 deal-0 card-d0-s2-v1)
    (TO-DEAL card-d0-s2-v1 pile-3 deal-0 card-d0-s2-v3)
    (TO-DEAL card-d0-s3-v6 pile-4 deal-1 deal-1)
    (TO-DEAL card-d0-s1-v4 pile-0 deal-1 card-d0-s2-v5)
    (TO-DEAL card-d0-s2-v5 pile-1 deal-1 card-d0-s0-v5)
    (TO-DEAL card-d0-s0-v5 pile-2 deal-1 card-d0-s1-v1)
    (TO-DEAL card-d0-s1-v1 pile-3 deal-1 card-d0-s3-v6)
    (= (total-cost) 0)
)
(:goal
(and
