(define (problem spider-2-2-6-4-2-2701)
(:domain spider-axioms)
; Using 2 decks of cards with 2 suits per deck and 6 values per suit
;
; Deals
; deal 0: d0-s0-v3 d0-s0-v5 d1-s0-v2 d1-s1-v1
; deal 1: d1-s0-v0 d0-s1-v2 d0-s0-v2 d0-s1-v1
;
; Initial configuration of piles
; pile 0: d1-s1-v2 d0-s0-v0 d0-s1-v0 d1-s0-v3
; pile 1: d1-s0-v4 d0-s0-v1 d0-s1-v4 d1-s1-v3
; pile 2: d0-s1-v5 d1-s1-v0 d1-s0-v5 d1-s0-v1
; pile 3: d0-s1-v3 d0-s0-v4 d1-s1-v5 d1-s1-v4
(:objects
    card-d0-s0-v0 - card
    card-d0-s0-v1 - card
    card-d0-s0-v2 - card
...
(:init
    (on card-d0-s0-v0 card-d1-s1-v2)
    (on card-d0-s1-v0 card-d0-s0-v0)
    (on card-d1-s0-v3 card-d0-s1-v0)
    (on card-d1-s1-v2 pile-0)
    (clear card-d1-s0-v3)
    (in-play card-d1-s1-v2)
    (in-play card-d0-s0-v0)
    (in-play card-d0-s1-v0)
    (in-play card-d1-s0-v3)
    (on card-d0-s0-v1 card-d1-s0-v4)
    (on card-d0-s1-v4 card-d0-s0-v1)
    (on card-d1-s1-v3 card-d0-s1-v4)
    ...
    (on card-d1-s1-v0 card-d0-s1-v5)
    (on card-d1-s0-v5 card-d1-s1-v0)
    (on card-d1-s0-v1 card-d1-s0-v5)
    (on card-d0-s1-v5 pile-2)
    (clear card-d1-s0-v1)
    (in-play card-d0-s1-v5)
    (in-play card-d1-s1-v0)
    (in-play card-d1-s0-v5)
    (in-play card-d1-s0-v1)
    (on card-d0-s0-v4 card-d0-s1-v3)
    (on card-d1-s1-v5 card-d0-s0-v4)
    (on card-d1-s1-v4 card-d1-s1-v5)
    (on card-d0-s1-v3 pile-3)
    (clear card-d1-s1-v4)
    ...
    (on card-d1-s0-v2 card-d0-s0-v5)
    (on card-d1-s1-v1 card-d1-s0-v2)
    (clear card-d1-s1-v1)
    (on card-d1-s0-v0 deal-1)
    (on card-d0-s1-v2 card-d1-s0-v0)
    ...
    (IS-KING card-d1-s1-v5)
    (NEXT-DEAL deal-0 deal-1)
    (NEXT-DEAL deal-1 deal-2)
    (TO-DEAL card-d0-s0-v3 pile-3 deal-0 deal-0)
    (TO-DEAL card-d1-s1-v1 pile-0 deal-0 card-d1-s0-v2)
    (TO-DEAL card-d1-s0-v2 pile-1 deal-0 card-d0-s0-v5)
    (TO-DEAL card-d0-s0-v5 pile-2 deal-0 card-d0-s0-v3)
    (TO-DEAL card-d1-s0-v0 pile-3 deal-1 deal-1)
    (TO-DEAL card-d0-s1-v1 pile-0 deal-1 card-d0-s0-v2)
    (TO-DEAL card-d0-s0-v2 pile-1 deal-1 card-d0-s1-v2)
    (TO-DEAL card-d0-s1-v2 pile-2 deal-1 card-d1-s0-v0)
    (= (total-cost) 0)
)
(:goal
(and
